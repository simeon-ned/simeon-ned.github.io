...
lang: eng # this will translate to russian 
...
author:
  - name: Simeon Nedelchev
    ...
    email: SINedelchev@sberbank.ru
    affiliation: 
      - name: Sberbank Robotics Laboratory
        city: Moscow
        state: Moscow
        url: [https://sberlabs.com/laboratories/tsentr-robototekhniki/]
copyright: 
...
format: 
    revealjs:
        theme: [default, styles/sber_style.scss]
        slide-number: true
        # theme: default
        chalkboard: 
            theme: whiteboard
        ...
        # fontsize: 16
        cap-location: bottom
        logo: images/logos/sber_logo.png
        # css: styles.css
...
![Sberbank Agile Office](images/figures/sber_office.jpg){#fig-inno}
...
![Sberbank office entry](images/figures/sber_office_entry.jpg){#fig-inno_gym}

![Inside robotics lab](images/figures/sberbank_inside.jpg){#fig-inno_pool}
...
{{< video https://www.youtube.com/watch?v=ksq72_eHUT0 width="100%" height="85%" >}}
